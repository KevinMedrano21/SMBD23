...
namespace SMBD23
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (v == 0 || v == 2)
            {
                if (conn.State == ConnectionState.Closed)
                    conn.Open();
                com = new SqlCommand();
                com.CommandText = "insert into  Contenido values (" + Convert.ToInt32(textBox1.Text) + ", '" + textBox2.Text + "', '" + comboBox1.Text + "', '" + textBox4.Text + "'," + Convert.ToInt32(textBox5.Text) + "," + Convert.ToInt32(textBox6.Text) + ", " + Convert.ToInt32(textBox7.Text) + ")";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                db = Db4oEmbedded.OpenFile("SMBDOO.dat");
                Contenido c = new Contenido(Convert.ToInt32(textBox1.Text));
                IObjectSet<Contenido> res = db.QueryByExample(c);
                foreach (Contenido obj in res)
                {
